...
public class IntentarTransferir implements Task {

    private final String monto;
    private final String beneficiario;

    public IntentarTransferir(String monto, String beneficiario) {
        this.monto = monto;
        this.beneficiario = beneficiario;
    }

    public static IntentarTransferir a(String monto, String beneficiario) {
        return instrumented(IntentarTransferir.class, monto, beneficiario);
    }
